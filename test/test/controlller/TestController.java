...
//        ContactController.getInstance().saveContact(contacts, new File("ciprian.bin"));
//        List<Contact> contacts1 = ContactController.getInstance().openContact(new File("ciprian.bin"));
//        System.out.println(contacts1);
//        Collections.sort(contacts1, new ComparatorNume());
//        System.out.println(contacts1);
//        
//    }
}
